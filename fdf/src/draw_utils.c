...
/*   Updated: 2026/01/08 01:01:28 by mmubina          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
uint32_t	get_height_color(float z, float z_max, float z_min)
{
	...
	if (ratio < 0.25f)
	{
		r = (uint8_t)(250 + (207 - 250) * (ratio / 0.25f));
		g = (uint8_t)(250 + (207 - 250) * (ratio / 0.25f));
		b = (uint8_t)(248 + (200 - 248) * (ratio / 0.25f));
	}
	else if (ratio < 0.5f)
	{
		r = (uint8_t)(207 + (200 - 207) * ((ratio - 0.25f) / 0.25f));
		g = (uint8_t)(207 + (175 - 207) * ((ratio - 0.25f) / 0.25f));
		b = (uint8_t)(200 + (140 - 200) * ((ratio - 0.25f) / 0.25f));
	}
	else if (ratio < 0.75f)
	{
		r = (uint8_t)(200 + (175 - 200) * ((ratio - 0.5f) / 0.25f));
		g = (uint8_t)(175 + (88 - 175) * ((ratio - 0.5f) / 0.25f));
		b = (uint8_t)(140 + (108 - 140) * ((ratio - 0.5f) / 0.25f));
	}
	else
	{
		r = (uint8_t)(175 + (39 - 175) * ((ratio - 0.75f) / 0.25f));
		g = (uint8_t)(88 + (57 - 88) * ((ratio - 0.75f) / 0.25f));
		b = (uint8_t)(108 + (29 - 108) * ((ratio - 0.75f) / 0.25f));
	}
	return ((r << 24) | (g << 16) | (b << 8) | 0xFF);
}
